        ...
        <TranslateSwitch locale={params.lng}>
          <Translation lang="de">
            ...
            <p className="mb-4">
              ...
              einzustellen, bin ich mit Sack &amp; Pack auf Next.js und Vercel
              Pro umgezogen.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              Google so einiges an Problemen gemacht hat, kommt diese Version
              nun komplett ohne <i>IFrames</i> aus.
            </p>
            <p className="mb-4">
          ...
          <Translation lang="en">
            ...
            <p className="mb-4">
              As you may have noticed in recent weeks, there&apos;s been quite a
              bit happening on these pages.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              self-written framework of my site. The main reason for this is
              that Gatsby calculates and updates images during compilation,
              which is unfortunately quite incompatible with Vercel, especially
              when there are as many images as there are here.
            </p>
            <p className="mb-4">
