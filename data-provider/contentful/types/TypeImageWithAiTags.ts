...
export type TypeImageWithAiTags<Modifiers extends ChainModifiers, Locales extends LocaleCode = LocaleCode> = Entry<TypeImageWithAiTagsSkeleton, Modifiers, Locales>;
