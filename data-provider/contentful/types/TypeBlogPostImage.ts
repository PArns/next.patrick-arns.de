...
export type TypeBlogPostImage<Modifiers extends ChainModifiers, Locales extends LocaleCode = LocaleCode> = Entry<TypeBlogPostImageSkeleton, Modifiers, Locales>;
